...
class DashboardOneTiketOut extends StatelessWidget {
  final DateTime startData;
  final DateTime endData;
  final PeriodTypeDashboardOne period;
  final int? company;
  const DashboardOneTiketOut({super.key, required this.startData, required this.endData, required this.period, this.company});
...
class _ViewOut extends StatefulWidget {
  final DateTime startData;
  final DateTime endData;
  final PeriodTypeDashboardOne period;
  final int? company;
  ...
  @override
  State<_ViewOut> createState() => _ViewOutState();
}
...
class _ViewOutState extends State<_ViewOut> {
  ...
  @override
  void didUpdateWidget(_ViewOut old) {
